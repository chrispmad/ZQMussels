---
title: "01_Golden_Mussel_Survival_Probability_Assessment"
author: "John Phelan"
date: "`r Sys.Date()`"
output: html_document
---

This script assesses the probability of survival of Golden Mussel in freshwater subwatersheds of BC, using environmental data (dissolved and total calcium, and water temperature from the environmental monitoring database). It is modelled after the 2017 DFO risk assessment of Canada for invasion of these species and Adam Sepulveda et al's more recent methodology.
...
write.csv(calcium_match_to_wbs, "./output/calcium_only_filtered_for_sub_300_and_100_mg_L_at_waterbody_scale_golden_mussel.csv", row.names = F)
```
...
ggsave(filename = './output/mean_pH_within_ideal_ZQ_Mussels_range_by_subwatershed_golden_mussel.png',
       width = 8, height = 8)

openxlsx::write.xlsx(pH_within_ideal_ZQ_range, './output/mean_pH_waterbody_matched_within_ideal_ZQ_Mussels_range_by_subwatershed_golden_mussel.xlsx')
...
ggplot(watershed) +
  ...
  labs(fill = 'Binned Calcium',
       ...
       subtitle = paste0(nrow(watershed[watershed$calc_bin != 'No Data',]), ' of 246 with data; unsuitable pH (<6 or >9) or Temp (<15C) reduced risk by one level (if not already "No Risk")'))
