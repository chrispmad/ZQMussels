...
watershed = watershed |> 
  dplyr::mutate(calc_bin = case_when(
    ...
    mean_calcium >= 15 & mean_calcium < 24 ~ 'Moderate (15 to <24 mg/L)',
    mean_calcium >= 24 ~ 'High (24+ mg/L)',
  ...
  mutate(calc_bin_n = case_when(
    ...
    calc_bin == 'Moderate (15 to <24 mg/L)' ~ 2,
    calc_bin == 'High (24+ mg/L)' ~ 3,
    calc_bin == 'No Data' ~ 99 
  ))
```
