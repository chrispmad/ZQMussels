...
dat %>% 
  ...
  theme(text = element_text(colour = "#484d4e")) +
  facet_wrap( ~ Year) +
...
ggsave("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Pacific/Pacific_LowRisk_DayOfWeek.png",
       pacplot1,device = "png", height = 3.5, width = 6)
print(pacplot1)

#Pacific - Low Risk by Hour
pacplot2 = dat %>% 
  filter(Type == "LowRisk", Station == "Pacific", Year != "2015") %>% 
  group_by(Year, Type, HourOfDay) %>% 
  summarise(NumberInsp = n()) %>% 
  ungroup() %>% 
  ggplot() +
  ...
  scale_x_continuous(breaks = seq(from = 0, to = 23, by = 2),
                     limits = c(0, 24))
ggsave("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Pacific/Pacific_LowRisk_HourOfDay.png",
       pacplot2,device = "png", height = 4, width = 8)
print(pacplot2)
...
ggsave("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Pacific/Pacific_HighRisk_DayOfWeek.png",pacplot3,device = "png", height = 3.5, width = 6)
...
ggsave("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Pacific/Pacific_HighRisk_HourOfDay.png",pacplot4,device = "png", height = 4, width = 8)
print(pacplot4)
```
