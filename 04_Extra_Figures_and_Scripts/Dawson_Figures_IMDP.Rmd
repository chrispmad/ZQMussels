...
dat_all = dat_all %>% 
  ...
  filter(str_detect(Station, "Dawson")) %>% 
  mutate(Station = "Dawson Creek")
...
#Dawson Creek - Low Risk inspections by Day
...
#Low Risk
d1 = dat_days %>% 
  filter(Year == my.year, Type == "LowRisk") %>% 
  ggplot() +
  ...
  labs(y = "Low Risk Inspections",
       x = "Day of Week",
       title = paste0("Dawson Creek - Low Risk Inspections by Day (",my.year,")"))

print(d1)


d1_multiyear = append(d1_multiyear, d1)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/DawsonStation/LowRisk_DayOfWeek_",my.year,".png"),
       d1,
       device = "png", height = 3.5, width = 6)
}

ggarrange(d1_multiyear[[1]])
...
d2 = dat_hours %>% 
  ...
  labs(y = "Low Risk Inspections",
       x = "Hour Of Day",
       title = paste0("Dawson Creek - Low Risk Inspections by Hour (",my.year,")"))

print(d2)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/DawsonStation/LowRisk_HourOfDay_",my.year,".png"),
       d2,
       device = "png", height = 3.5, width = 6)
}
...
#High Risk
d3 = dat_days %>% 
  filter(Year == my.year, Type == "HighRisk") %>% 
  ggplot() +
  ...
  labs(y = "High Risk Inspections",
       x = "Day of Week",
       title = paste0("Dawson Creek - High Risk Inspections by Day (",my.year,")"))

print(d3)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/DawsonStation/HighRisk_DayOfWeek_",my.year,".png"),
       d3,
       device = "png", height = 3.5, width = 6)
}
...
d4 = dat_hours %>% 
  ...
  labs(y = "High Risk Inspections",
       x = "Hour Of Day",
       title = paste0("Dawson Creek - High Risk Inspections by Hour (",my.year,")"))

print(d4)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/DawsonStation/HighRisk_HourOfDay_",my.year,".png"),
       d4,
       device = "png", height = 3.5, width = 6)
}
...
#Mt. Robson - Low Risk inspections by Day
for(my.year in unique(dat$Year)){
...
d1 = dat_days %>% 
  ...
  labs(y = "Low Risk Inspections",
       x = "Day of Week",
       title = paste0("Mt. Robson - Low Risk Inspections by Day (",my.year,")"))

# print(d1)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Mt.Robson/LowRisk_DayOfWeek_",my.year,".png"),
       d1,
       device = "png", height = 3.5, width = 6)
}
...
d2 = dat_hours %>% 
  ...
  labs(y = "Low Risk Inspections",
       x = "Hour Of Day",
       title = paste0("Mt. Robson - Low Risk Inspections by Hour (",my.year,")"))

print(d2)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Mt.Robson/LowRisk_HourOfDay_",my.year,".png"),
       d2,
       device = "png", height = 3.5, width = 6)
}
...
d3 = dat_days %>% 
  ...
  labs(y = "High Risk Inspections",
       x = "Day of Week",
       title = paste0("Mt. Robson - High Risk Inspections by Day (",my.year,")"))

# print(d3)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Mt.Robson/HighRisk_DayOfWeek_",my.year,".png"),
       d3,
       device = "png", height = 3.5, width = 6)
}
...
d4 = dat_hours %>% 
  ...
  labs(y = "High Risk Inspections",
       x = "Hour Of Day",
       title = paste0("Mt. Robson - High Risk Inspections by Hour (",my.year,")"))

# print(d4)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Mt.Robson/HighRisk_HourOfDay_",my.year,".png"),
       d4,
       device = "png", height = 3.5, width = 6)
}
...
#Olsen - Low Risk inspections by Day
for(my.year in unique(dat$Year)){
...
d1 = dat_days %>% 
  ...
  labs(y = "Low Risk Inspections",
       x = "Day of Week",
       title = paste0("Olsen - Low Risk Inspections by Day (",my.year,")"))

# print(d1)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Olsen/LowRisk_DayOfWeek_",my.year,".png"),
       d1,
       device = "png", height = 3.5, width = 6)
}
...
d2 = dat_hours %>% 
  ...
  labs(y = "Low Risk Inspections",
       x = "Hour Of Day",
       title = paste0("Olsen - Low Risk Inspections by Hour (",my.year,")"))

print(d2)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Olsen/LowRisk_HourOfDay_",my.year,".png"),
       d2,
       device = "png", height = 3.5, width = 6)
}
...
d3 = dat_days %>% 
  ...
  labs(y = "High Risk Inspections",
       x = "Day of Week",
       title = paste0("Olsen - High Risk Inspections by Day (",my.year,")"))

# print(d3)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Olsen/HighRisk_DayOfWeek_",my.year,".png"),
       d3,
       device = "png", height = 3.5, width = 6)
}
...
d4 = dat_hours %>% 
  ...
  labs(y = "High Risk Inspections",
       x = "Hour Of Day",
       title = paste0("Olsen - High Risk Inspections by Hour (",my.year,")"))

# print(d4)

ggsave(paste0("C:/Users/CMADSEN/Downloads/LocalRWork/output/MartinaFigures/Olsen/HighRisk_HourOfDay_",my.year,".png"),
       d4,
       device = "png", height = 3.5, width = 6)
}
