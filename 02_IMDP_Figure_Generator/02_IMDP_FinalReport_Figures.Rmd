...
rovers = data.frame(Station = c("Hwy 97c","Keremeos","Greenwood","Kaleden","Fraser Valley Roving","Pacific","Penticton Roving"),
                    StationType = "Roving")
...
if(!interactive()) {
  tmap_save(tm = map_1_tmap, filename = 'Map1_Stations_by_Type.jpg', width = 7.6, height = 6.4, dpi = 300)
}
```
...
if(!interactive()) {
tmap_save(tm = map_2_tmap, filename = 'Map2_Total_Inspections_by_Station.jpg', width = 7.6, height = 6.4, dpi = 300)
}
```
