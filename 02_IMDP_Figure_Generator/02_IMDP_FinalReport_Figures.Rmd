...
roving.stations = c("Penticton Roving","Lower Mainland Roving",
                    "Keremeos (Hwy 3)","Sumas Border")

part.time.stations = c("Sumas","Pacific","Cutts (Hwy 93)","Radium")
...
if(!interactive()) {
tmap_save(tm = map_5_tmap, filename = paste0(my.external.output.folder, '/GIS Maps and Excel Figures/ExcelFigures/Map5_Home_Residence_Frequency_HighRisk.jpg'), width = 7.6, height = 6.4, dpi = 300)
}
```
