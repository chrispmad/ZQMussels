...
bc_stations_basemap_white<- basemaps::basemap_terra(ext = bc_station_view, map_service = 'esri', map_type = 'world_street_map')
...
p1<-ggplot()+
  ...
  scale_fill_manual(name = "2024 Watercraft \n Inspection Stations", values = c("Permanent Inspection Station" = "lightblue", "Roving Inspection Crew" = "purple"))+
...
north_america_stations_basemap_white<- basemaps::basemap_terra(ext = northamerica_view, map_service = 'esri', map_type = 'world_street_map')
...
map_home_res_high_risk_ggplot = ggplot() +
  tidyterra::geom_spatraster_rgb(data = north_america_stations_basemap_white) +
  coord_sf(
