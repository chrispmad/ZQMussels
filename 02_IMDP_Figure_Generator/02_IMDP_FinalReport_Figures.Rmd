...
map_1_tmap = tm_shape(bc_stations_basemap, bbox = bc_station_view) +
  ...
  tm_shape(stations_for_maps) + 
    ...
    tm_text("map_label", auto.placement = TRUE, 
            size = 0.65) +
  tm_scale_bar() + 
...
tmap_save(tm = map_1_tmap, filename = 'Map1_Stations_by_Type.jpg', dpi = 300)
```
...
tmap_save(tm = map_2_tmap, filename = 'Map2_Total_Inspections_by_Station.jpg', dpi = 300)
```
...
tmap_save(tm = map_3_tmap, filename = 'Map3_Home_Residence_Frequency.jpg', dpi = 300)
```
...
tmap_save(tm = map_4_tmap, filename = 'Map4_HighRisk_Inspections_by_Station.jpg', dpi = 300)
```
...
tmap_save(tm = map_5_tmap, filename = 'Map5_Home_Residence_Frequency_HighRisk.jpg', dpi = 300)
```
...
tmap_save(tm = map_6_tmap, filename = 'Map6_Destination_locations_HighRisk.jpg', dpi = 300)
...
tmap_save(tm = map_7_tmap, filename = 'Map7_Home_Residence_Frequency_MusselFouled.jpg', dpi = 300)
```
...
tmap_save(tm = map_8_tmap, filename = 'Map8_Commercially_Hauled_Watercraft_Sources.jpg', dpi = 300)
```
...
tmap_save(tm = map_9_tmap, filename = 'Map9_Map_of_Lake_Sampling.jpg', dpi = 300)
```
