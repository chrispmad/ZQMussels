...
## there are 19 layers in the wordclim data - this is what they are
...
ggsave(filename = paste0("./output/TemperatureCorrection_",temp_limit,"_",climate_model,"_RiskMap.png"), plot = my_plot, dpi = 150, width = 10, height = 7)
```
