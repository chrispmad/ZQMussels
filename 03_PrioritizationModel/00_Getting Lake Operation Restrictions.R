...
prohibited = sched2 %>% 
  ...
  # Correct latitude for Sayres Lake
  dplyr::mutate(lat = ifelse(Name_Given == 'Sayres Lake', 49.32079, lat)) |> 
...
prohibited = prohibited %>% st_transform(crs = 4326)
...
# write_sf(prohibited, paste0(my_opts$base_dir,"/03_PrioritizationModel/data/complete_watercraft_restrictions.gpkg"))
