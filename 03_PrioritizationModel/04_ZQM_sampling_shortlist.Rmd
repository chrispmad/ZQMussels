...
source(paste0('03_PrioritizationModel/utility_functions.R'))
```
...
```{r read_in_data}
# Read RDS.
dat = read_rds(paste0("03_PrioritizationModel/data/data_for_making_shortlist.rds"))
# if(interactive()){
...
sample_protocol_2022 = get_wb_list_from_protocol_doc(
  officer::read_docx(paste0(paste0(lan_root,"2 SCIENCE - Invasives/SPECIES/Zebra_Quagga_Mussel/Operations/Lake Monitoring/2022/Sampling protocol/2022 Invasive Mussel Field Protocol_Draft_V1.docx")))
)

sample_protocol_2023 = get_wb_list_from_protocol_doc(
  officer::read_docx(paste0(lan_root,'2 SCIENCE - Invasives/SPECIES/Zebra_Quagga_Mussel/Operations/Lake Monitoring/2023/Sampling protocol/2023 Invasive Mussel Field Protocol_Draft_V1.docx'))
)

sample_protocol_2024 = get_wb_list_from_protocol_doc(
  officer::read_docx(paste0(lan_root,"2 SCIENCE - Invasives//SPECIES/Zebra_Quagga_Mussel/Operations/Lake Monitoring/2024/Sampling protocol/2024 Invasive Mussel Field Protocol_Final.docx"))
)
