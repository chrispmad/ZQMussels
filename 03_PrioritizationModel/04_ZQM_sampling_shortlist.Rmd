...
# 2024 waterbodies to be sampled.
...
if(interactive()){
  waterb_full_tbl |> 
    dplyr::filter(str_detect(GNIS_NA,"Rosebud")) |> 
    View()
}
```
...
last_year = read_excel(paste0(my_opts$zqm_operations_data_folder,"Lake Monitoring/2024/Prioritization model/Final waterbody list based on risk estimates_2024.xlsx"))
